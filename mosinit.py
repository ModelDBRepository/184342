'''
Current clamp demo using Allen Brain's model 473871773.
...
from neuron473871773 import Neuron473871773
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473871773(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473871773; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-83.4818191528)
        h.fcurrent()
